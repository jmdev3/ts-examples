...
const parseTransactionStatus = (data) => {
    ...
    return (0, util_1.removeEmpty)({
        ...
        callEventStatus,
        callEventLog,
        chainData: chainData ? (0, chains_1.parseChainData)([chainData]).pop() : undefined,
        transactionUrl
    });
};
...
const parseStatusResponse = (response, headers) => {
    ...
    const { id, status, gasStatus, isGMPTransaction, axelarTransactionUrl, fromChain, toChain, timeSpent, squidTransactionStatus } = response.data;
    return (0, util_1.removeEmpty)({
        id,
        status,
        gasStatus,
