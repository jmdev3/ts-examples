...
const parseRouteResponse = (response, headers) => {
    ...
    const routeResponse = {
        ...
        route: route && {
            estimate: (0, exports.parseEstimate)(route.estimate),
            transactionRequest: route.transactionRequest &&
                (0, exports.parseTransactionRequest)(route.transactionRequest),
            params: (0, exports.parseParams)(route.params)
        },
        status,
        message
    };
    return (0, util_1.removeEmpty)(routeResponse);
};
